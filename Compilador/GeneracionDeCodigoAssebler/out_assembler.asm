...
.DATA
    ...
    _procedure_2@main@procedure_1 DD 0
    _procedure_3@main DD 0
    @aux1 DD 1.000000
    @aux2 DD ? 
    @aux3 DD 5000.000000
    @aux4 DD 3.300000
    ...
    @aux9 DD ? 
    @aux10 DD -7.300000
    str10 DB "Error: No esta permitida la recursion en un procedimiento" , 0 
.CODE
    ...
    procedure_2@main@procedure_1 PROC
        CMP _procedure_2@main@procedure_1, 1
        JE Error_recursion
        MOV _procedure_2@main@procedure_1, 1
        MOV ECX,5
        ADD ECX,7
        MOV e@main@procedure_1@procedure_2,ECX
        ret
        procedure_2@main@procedure_1  ENDP
    procedure_3@main PROC
        CMP _procedure_3@main, 1
        JE Error_recursion
        MOV _procedure_3@main, 1
        MOV ECX,2
      ...
      Error_recursion :
        invoke MessageBox, NULL, addr str10, addr str10, MB_OK
