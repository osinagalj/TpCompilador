...
//CAMINO 1
    ...
    matrizAS[1][SIGNO_OPERADOR]= {ESTADO_FINAL, &AccionesSemanticas::devolverIdentificador};
...
//CAMINO 2
    ...
    matrizAS[2][SIGNO_OPERADOR]= {ESTADO_FINAL, &AccionesSemanticas::devolverReservada};
...
//CAMINO 3
    ...
    matrizAS[3][SIGNO_OPERADOR]= {ESTADO_FINAL, &AccionesSemanticas::devolverConstante};
...
//CAMINO 4
    ...
    matrizAS[4][SIGNO_OPERADOR]= {ESTADO_FINAL, &AccionesSemanticas::mensajeError};
...
//CAMINO 5
    ...
    matrizAS[5][SIGNO_OPERADOR]= {ESTADO_FINAL, &AccionesSemanticas::mensajeError};
...
//CAMINO 6
    ...
    matrizAS[6][SIGNO_OPERADOR]= {ESTADO_FINAL, &AccionesSemanticas::mensajeError};
...
//CAMINO 7
    ...
    matrizAS[7][SIGNO_OPERADOR]= {ESTADO_FINAL, &AccionesSemanticas::devolverFloat};
...
//CAMINO 8
    ...
    matrizAS[8][COMPARADOR_IGUAL]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenorIgual};
    //DEVOLVER MENOR
    matrizAS[8][DIGITO]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][SIGNO_SUMA] = {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][SIGNO_RESTA]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][F_MINUSCULA] = {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][L_MINUSCULA] = {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][SIMBOLO_DISTINTO]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][GUION_BAJO]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][SIMBOLO_PUNTO]={ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][MAYUSCULA]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][MINUSCULA]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][OTRO]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][SIMBOLO_PORCENTAJE]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][SIGNO_RESTA]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][SIGNO_DIVISION]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][SIGNO_OPERADOR]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][COMPARADOR_MAYOR]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][COMILLA]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][LITERALES]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][BL_TAB_NL]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
    matrizAS[8][SIMBOLO_FIN_DE_ARCHIVO]= {ESTADO_FINAL, &AccionesSemanticas::devolverMenor};
//CAMINO 9
    //AGREGAR
    matrizAS[0][COMPARADOR_MAYOR]= {9, &AccionesSemanticas::agregarCaracter};
    //DEVOLVER MAYOR IGUAL
    matrizAS[9][COMPARADOR_IGUAL]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayorIgual};
    //DEVOLVER MENOR
    matrizAS[9][DIGITO]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][SIGNO_SUMA] = {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][SIGNO_RESTA]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][F_MINUSCULA] = {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][L_MINUSCULA] = {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][SIMBOLO_DISTINTO]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][GUION_BAJO]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][SIMBOLO_PUNTO]={ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][MAYUSCULA]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][MINUSCULA]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][OTRO]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][SIMBOLO_PORCENTAJE]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][SIGNO_RESTA]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][SIGNO_DIVISION]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][SIGNO_OPERADOR]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][COMPARADOR_MENOR]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][COMILLA]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][LITERALES]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][BL_TAB_NL]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
    matrizAS[9][SIMBOLO_FIN_DE_ARCHIVO]= {ESTADO_FINAL, &AccionesSemanticas::devolverMayor};
//CAMINO 10
    //AGREGAR
    matrizAS[0][COMPARADOR_IGUAL]= {10, &AccionesSemanticas::agregarCaracter};
    //DEVOLVER IGUAL
    matrizAS[10][COMPARADOR_IGUAL]= {ESTADO_FINAL, &AccionesSemanticas::devolverIgual};
    //DEVOLVER ASIGNACION
    matrizAS[10][DIGITO]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][SIGNO_SUMA] = {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][SIGNO_RESTA]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][F_MINUSCULA] = {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][L_MINUSCULA] = {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][SIMBOLO_DISTINTO]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][GUION_BAJO]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][SIMBOLO_PUNTO]={ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][MAYUSCULA]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][MINUSCULA]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][OTRO]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][SIMBOLO_PORCENTAJE]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][SIGNO_DIVISION]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][SIGNO_OPERADOR]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][COMPARADOR_MENOR]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][COMPARADOR_MAYOR]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][COMILLA]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][LITERALES]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][BL_TAB_NL]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
    matrizAS[10][SIMBOLO_FIN_DE_ARCHIVO]= {ESTADO_FINAL, &AccionesSemanticas::devolverAsignacion};
//CAMINO 11
    //AGREGAR
    matrizAS[0][SIMBOLO_DISTINTO]= {11, &AccionesSemanticas::agregarCaracter};
    //DEVOLVER DISTINTO
    matrizAS[11][COMPARADOR_IGUAL]= {ESTADO_FINAL, &AccionesSemanticas::devolverDistinto};
    //INFORMAR ERROR
    ...
    matrizAS[11][COMPARADOR_IGUAL]= {ESTADO_FINAL, &AccionesSemanticas::mensajeError};
...
//CAMINO 13
    ...
    //DEVOLVER DIVISION
    matrizAS[13][SIMBOLO_DISTINTO]= {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][COMPARADOR_IGUAL]= {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][SIGNO_SUMA] = {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][SIGNO_RESTA]= {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][SIGNO_OPERADOR]= {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][LITERALES]= {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][SIMBOLO_FIN_DE_ARCHIVO]={ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][DIGITO]= {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][F_MINUSCULA] = {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][L_MINUSCULA] = {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][GUION_BAJO]= {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][SIMBOLO_PUNTO]={ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][MAYUSCULA]= {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][MINUSCULA]= {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][OTRO]= {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][COMILLA]= {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
    matrizAS[13][COMPARADOR_MENOR]= {ESTADO_FINAL, &AccionesSemanticas::devolverDivision};
...
//CAMINOS DIRECTOS
    ...
    matrizAS[0][SIGNO_RESTA]= {ESTADO_FINAL, &AccionesSemanticas::devolverResta};
